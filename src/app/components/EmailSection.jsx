            ...
            <div>
                ...
                <div className="socials flex flex-row gap-2">
                    <Link href="https://www.github.com/swiftxo" target="_blank">
                        <Image src={github_icon} alt="Github Icon" width={40} height={40}/>
                    </Link>
                    <Link href="https://www.linkedin.com/in/sohanhossain2004/" target="_blank">
                        <Image src={linkedin_icon} alt="LinkedIn Icon" width={40} height={40}/>
                    </Link>
                    <Link href="https://www.discordapp.com/users/476464850630082580/" target="_blank">
                        <Image src={discord_icon} alt="Discord Icon" width={40} height={40}/>
                    </Link>
                </div>
            </div>
            <div>
                <form className="flex flex-col" onSubmit={handleSubmit}>
                    ...
                    <div className="mb-6">
                        ...
                        <textarea name="message" id="message" className="bg-[#6883a1] border border-[#e0dddd] placeholder-[#ffffffab]
                            text-gray-100 text-sm rounded-lg block w-full p-2.5" placeholder="Sohan, I heard about your old pet ducks, tell me more!" />
